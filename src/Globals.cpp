...
PasteurizerRelays pasteurizerRelays(2, 3, 4, 5, 6, 7);
...
ChillControl chillControl(pasteurizerRelays, 11, 28);
...
void initGlobals()
{
    ...
    pasteurizerRelays.attachControllers(&heatControl, &chillControl);
